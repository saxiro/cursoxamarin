...
namespace BR.Com.Softwareexpress.Sitef.Android {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']"
	[global::Android.Runtime.Register ("br/com/softwareexpress/sitef/android/CliSiTefI", DoNotGenerateAcw=true)]
	public partial class CliSiTefI : global::Java.Lang.Object {


		// Metadata.xml XPath field reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/field[@name='CMD_CONFIRMA_CANCELA']"
		[Register ("CMD_CONFIRMA_CANCELA")]
		public const int CmdConfirmaCancela = (int) 20;

		// Metadata.xml XPath field reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/field[@name='CMD_EXIBE_CABECALHO']"
		[Register ("CMD_EXIBE_CABECALHO")]
		public const int CmdExibeCabecalho = (int) 15;

		// Metadata.xml XPath field reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/field[@name='CMD_MENSAGEM']"
		[Register ("CMD_MENSAGEM")]
		public const int CmdMensagem = (int) 3;

		// Metadata.xml XPath field reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/field[@name='CMD_MENSAGEM_CLIENTE']"
		[Register ("CMD_MENSAGEM_CLIENTE")]
		public const int CmdMensagemCliente = (int) 2;

		// Metadata.xml XPath field reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/field[@name='CMD_MENSAGEM_OPERADOR']"
		[Register ("CMD_MENSAGEM_OPERADOR")]
		public const int CmdMensagemOperador = (int) 1;

		// Metadata.xml XPath field reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/field[@name='CMD_OBTEM_CAMPO']"
		[Register ("CMD_OBTEM_CAMPO")]
		public const int CmdObtemCampo = (int) 30;

		// Metadata.xml XPath field reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/field[@name='CMD_OBTEM_CAMPO_SEM_COLETA']"
		[Register ("CMD_OBTEM_CAMPO_SEM_COLETA")]
		public const int CmdObtemCampoSemColeta = (int) 29;

		// Metadata.xml XPath field reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/field[@name='CMD_OBTEM_CHEQUE']"
		[Register ("CMD_OBTEM_CHEQUE")]
		public const int CmdObtemCheque = (int) 31;

		// Metadata.xml XPath field reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/field[@name='CMD_OBTEM_CODIGO_EM_BARRAS']"
		[Register ("CMD_OBTEM_CODIGO_EM_BARRAS")]
		public const int CmdObtemCodigoEmBarras = (int) 35;

		// Metadata.xml XPath field reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/field[@name='CMD_OBTEM_QUALQUER_TECLA']"
		[Register ("CMD_OBTEM_QUALQUER_TECLA")]
		public const int CmdObtemQualquerTecla = (int) 22;

		// Metadata.xml XPath field reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/field[@name='CMD_OBTEM_VALOR']"
		[Register ("CMD_OBTEM_VALOR")]
		public const int CmdObtemValor = (int) 34;

		// Metadata.xml XPath field reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/field[@name='CMD_PERGUNTA_SE_INTERROMPE']"
		[Register ("CMD_PERGUNTA_SE_INTERROMPE")]
		public const int CmdPerguntaSeInterrompe = (int) 23;

		// Metadata.xml XPath field reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/field[@name='CMD_REMOVE_CABECALHO']"
		[Register ("CMD_REMOVE_CABECALHO")]
		public const int CmdRemoveCabecalho = (int) 16;

		// Metadata.xml XPath field reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/field[@name='CMD_REMOVE_MENSAGEM']"
		[Register ("CMD_REMOVE_MENSAGEM")]
		public const int CmdRemoveMensagem = (int) 13;

		// Metadata.xml XPath field reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/field[@name='CMD_REMOVE_MENSAGEM_CLIENTE']"
		[Register ("CMD_REMOVE_MENSAGEM_CLIENTE")]
		public const int CmdRemoveMensagemCliente = (int) 12;

		// Metadata.xml XPath field reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/field[@name='CMD_REMOVE_MENSAGEM_OPERADOR']"
		[Register ("CMD_REMOVE_MENSAGEM_OPERADOR")]
		public const int CmdRemoveMensagemOperador = (int) 11;

		// Metadata.xml XPath field reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/field[@name='CMD_REMOVE_TITULO_MENU']"
		[Register ("CMD_REMOVE_TITULO_MENU")]
		public const int CmdRemoveTituloMenu = (int) 14;

		// Metadata.xml XPath field reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/field[@name='CMD_RETORNO_VALOR']"
		[Register ("CMD_RETORNO_VALOR")]
		public const int CmdRetornoValor = (int) 0;

		// Metadata.xml XPath field reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/field[@name='CMD_SELECIONA_MENU']"
		[Register ("CMD_SELECIONA_MENU")]
		public const int CmdSelecionaMenu = (int) 21;

		// Metadata.xml XPath field reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/field[@name='CMD_TITULO_MENU']"
		[Register ("CMD_TITULO_MENU")]
		public const int CmdTituloMenu = (int) 4;

		// Metadata.xml XPath field reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/field[@name='EVT_CONTINUA_CADASTRO_PIN_BT']"
		[Register ("EVT_CONTINUA_CADASTRO_PIN_BT")]
		public const int EvtContinuaCadastroPinBt = (int) 17;

		// Metadata.xml XPath field reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/field[@name='EVT_FALHA_CADASTRO_PIN_BT']"
		[Register ("EVT_FALHA_CADASTRO_PIN_BT")]
		public const int EvtFalhaCadastroPinBt = (int) 33;

		// Metadata.xml XPath field reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/field[@name='EVT_FIM_AGUARDA_CONEXAO_PP']"
		[Register ("EVT_FIM_AGUARDA_CONEXAO_PP")]
		public const int EvtFimAguardaConexaoPp = (int) 4;

		// Metadata.xml XPath field reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/field[@name='EVT_FIM_ATIVACAO_BT']"
		[Register ("EVT_FIM_ATIVACAO_BT")]
		public const int EvtFimAtivacaoBt = (int) 2;

		// Metadata.xml XPath field reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/field[@name='EVT_FIM_MODO_DISCOVER_BT']"
		[Register ("EVT_FIM_MODO_DISCOVER_BT")]
		public const int EvtFimModoDiscoverBt = (int) 16;

		// Metadata.xml XPath field reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/field[@name='EVT_INICIA_AGUARDA_CONEXAO_PP']"
		[Register ("EVT_INICIA_AGUARDA_CONEXAO_PP")]
		public const int EvtIniciaAguardaConexaoPp = (int) 3;

		// Metadata.xml XPath field reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/field[@name='EVT_INICIA_ATIVACAO_BT']"
		[Register ("EVT_INICIA_ATIVACAO_BT")]
		public const int EvtIniciaAtivacaoBt = (int) 1;

		// Metadata.xml XPath field reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/field[@name='EVT_INICIO_MODO_DISCOVER_BT']"
		[Register ("EVT_INICIO_MODO_DISCOVER_BT")]
		public const int EvtInicioModoDiscoverBt = (int) 9;

		// Metadata.xml XPath field reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/field[@name='EVT_PP_BT_CONFIGURADO']"
		[Register ("EVT_PP_BT_CONFIGURADO")]
		public const int EvtPpBtConfigurado = (int) 6;

		// Metadata.xml XPath field reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/field[@name='EVT_PP_BT_CONFIGURANDO']"
		[Register ("EVT_PP_BT_CONFIGURANDO")]
		public const int EvtPpBtConfigurando = (int) 5;

		// Metadata.xml XPath field reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/field[@name='EVT_PP_BT_DESCONECTADO']"
		[Register ("EVT_PP_BT_DESCONECTADO")]
		public const int EvtPpBtDesconectado = (int) 7;

		// Metadata.xml XPath field reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/field[@name='EVT_SUCESSO_CADASTRO_PIN_BT']"
		[Register ("EVT_SUCESSO_CADASTRO_PIN_BT")]
		public const int EvtSucessoCadastroPinBt = (int) 32;
		// Metadata.xml XPath class reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI.INIFile']"
		[global::Android.Runtime.Register ("br/com/softwareexpress/sitef/android/CliSiTefI$INIFile", DoNotGenerateAcw=true)]
		public partial class INIFile : global::Java.Lang.Object {

			internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("br/com/softwareexpress/sitef/android/CliSiTefI$INIFile", typeof (INIFile));
			...
			protected INIFile (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

			// Metadata.xml XPath constructor reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI.INIFile']/constructor[@name='CliSiTefI.INIFile' and count(parameter)=2 and parameter[1][@type='br.com.softwareexpress.sitef.android.CliSiTefI'] and parameter[2][@type='android.content.Context']]"
			[Register (".ctor", "(Lbr/com/softwareexpress/sitef/android/CliSiTefI;Landroid/content/Context;)V", "")]
			public unsafe INIFile (global::BR.Com.Softwareexpress.Sitef.Android.CliSiTefI __self, global::Android.Content.Context p1)
...
#pragma warning disable 0169
			...
			{
				global::BR.Com.Softwareexpress.Sitef.Android.CliSiTefI.INIFile __this = global::Java.Lang.Object.GetObject<global::BR.Com.Softwareexpress.Sitef.Android.CliSiTefI.INIFile> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI.INIFile']/method[@name='getValue' and count(parameter)=3 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='java.lang.String']]"
			...
			{
				const string __id = "getValue.(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;";
			...
			static Delegate cb_readFromFile_Ljava_lang_String_;
#pragma warning disable 0169
			static Delegate GetReadFromFile_Ljava_lang_String_Handler ()
			{
				if (cb_readFromFile_Ljava_lang_String_ == null)
					cb_readFromFile_Ljava_lang_String_ = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, IntPtr>) n_ReadFromFile_Ljava_lang_String_);
				return cb_readFromFile_Ljava_lang_String_;
			}

			static void n_ReadFromFile_Ljava_lang_String_ (IntPtr jnienv, IntPtr native__this, IntPtr native_p0)
			{
				global::BR.Com.Softwareexpress.Sitef.Android.CliSiTefI.INIFile __this = global::Java.Lang.Object.GetObject<global::BR.Com.Softwareexpress.Sitef.Android.CliSiTefI.INIFile> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
				string p0 = JNIEnv.GetString (native_p0, JniHandleOwnership.DoNotTransfer);
				__this.ReadFromFile (p0);
			}
#pragma warning restore 0169

			// Metadata.xml XPath method reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI.INIFile']/method[@name='readFromFile' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
			[Register ("readFromFile", "(Ljava/lang/String;)V", "GetReadFromFile_Ljava_lang_String_Handler")]
			public virtual unsafe void ReadFromFile (string p0)
			{
				const string __id = "readFromFile.(Ljava/lang/String;)V";
				IntPtr native_p0 = JNIEnv.NewString (p0);
				try {
		...
		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("br/com/softwareexpress/sitef/android/CliSiTefI", typeof (CliSiTefI));
		internal static new IntPtr class_ref {
			get {
				return _members.JniPeerType.PeerReference.Handle;
			}
		...
		protected CliSiTefI (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/constructor[@name='CliSiTefI' and count(parameter)=1 and parameter[1][@type='android.app.Activity']]"
		[Register (".ctor", "(Landroid/app/Activity;)V", "")]
		public unsafe CliSiTefI (global::Android.App.Activity p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/constructor[@name='CliSiTefI' and count(parameter)=1 and parameter[1][@type='android.content.Context']]"
		[Register (".ctor", "(Landroid/content/Context;)V", "")]
		public unsafe CliSiTefI (global::Android.Content.Context p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
		...
		public unsafe string Buffer {
			// Metadata.xml XPath method reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/method[@name='getBuffer' and count(parameter)=0]"
			...
			// Metadata.xml XPath method reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/method[@name='setBuffer' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		...
		public static unsafe global::BR.Com.Softwareexpress.Sitef.Android.CliSiTefI Instance {
			// Metadata.xml XPath method reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/method[@name='getInstance' and count(parameter)=0]"
			[Register ("getInstance", "()Lbr/com/softwareexpress/sitef/android/CliSiTefI;", "GetGetInstanceHandler")]
			get {
				const string __id = "getInstance.()Lbr/com/softwareexpress/sitef/android/CliSiTefI;";
				try {
					var __rm = _members.StaticMethods.InvokeObjectMethod (__id, null);
					return global::Java.Lang.Object.GetObject<global::BR.Com.Softwareexpress.Sitef.Android.CliSiTefI> (__rm.Handle, JniHandleOwnership.TransferLocalRef);
				} finally {
				}
			}
		}
		...
		public unsafe int ProximoComando {
			// Metadata.xml XPath method reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/method[@name='getProximoComando' and count(parameter)=0]"
		...
		public unsafe short TamanhoMaximo {
			// Metadata.xml XPath method reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/method[@name='getTamanhoMaximo' and count(parameter)=0]"
		...
		public unsafe short TamanhoMinimo {
			// Metadata.xml XPath method reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/method[@name='getTamanhoMinimo' and count(parameter)=0]"
		...
		public unsafe int TipoCampo {
			// Metadata.xml XPath method reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/method[@name='getTipoCampo' and count(parameter)=0]"
		...
		public unsafe int TipoCodigoEmBarras {
			// Metadata.xml XPath method reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/method[@name='getTipoCodigoEmBarras' and count(parameter)=0]"
...
#pragma warning disable 0169
		...
		{
			global::BR.Com.Softwareexpress.Sitef.Android.CliSiTefI __this = global::Java.Lang.Object.GetObject<global::BR.Com.Softwareexpress.Sitef.Android.CliSiTefI> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return JNIEnv.NewString (__this.VersaoCliSiTef);
		}
#pragma warning restore 0169

		public virtual unsafe string VersaoCliSiTef {
			// Metadata.xml XPath method reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/method[@name='getVersaoCliSiTef' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string VersaoCliSiTefI {
			// Metadata.xml XPath method reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/method[@name='getVersaoCliSiTefI' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe string Version {
			// Metadata.xml XPath method reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/method[@name='getVersion' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/method[@name='carregaArquivosTraducao' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/method[@name='carregaArquivosTraducao' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/method[@name='configuraIntSiTefInterativoEx' and count(parameter)=4 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='java.lang.String'] and parameter[4][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/method[@name='continuaFuncaoSiTefInterativo' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/method[@name='continuaFuncaoSiTefInterativo' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/method[@name='descarregaMensagens' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/method[@name='escreveMensagemPermanentePinPad' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/method[@name='finalizaTransacaoSiTefInterativoEx' and count(parameter)=5 and parameter[1][@type='int'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='java.lang.String'] and parameter[4][@type='java.lang.String'] and parameter[5][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/method[@name='leCartaoDiretoSeguro' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/method[@name='leSenhaDireto' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/method[@name='leSimNaoPinPad' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/method[@name='obtemInformacoesPinPad' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/method[@name='obtemQuantidadeTransacoesPendentes' and count(parameter)=2 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/method[@name='obtemVersao' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/method[@name='pinpadConecta' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/method[@name='pinpadDesconecta' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/method[@name='setContinuaNavegacao' and count(parameter)=1 and parameter[1][@type='int']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/method[@name='setDebug' and count(parameter)=1 and parameter[1][@type='boolean']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/method[@name='setMessageHandler' and count(parameter)=1 and parameter[1][@type='android.os.Handler']]"
		[Register ("setMessageHandler", "(Landroid/os/Handler;)V", "GetSetMessageHandler_Landroid_os_Handler_Handler")]
		public virtual unsafe void SetMessageHandler (global::Android.OS.Handler p0)
		{
			const string __id = "setMessageHandler.(Landroid/os/Handler;)V";
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [1];
				__args [0] = new JniArgumentValue ((p0 == null) ? IntPtr.Zero : ((global::Java.Lang.Object) p0).Handle);
				_members.InstanceMethods.InvokeVirtualVoidMethod (__id, this, __args);
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/method[@name='validaCampoCodigoEmBarras' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='br.com.softwareexpress.sitef.android']/class[@name='CliSiTefI']/method[@name='verificaPresencaPinPad' and count(parameter)=0]"
